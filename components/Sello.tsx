...
export function Sello({
  ...
  return (
    <div
      className={`relative flex h-37 w-37 shrink-0 rotate-[-9deg] items-center justify-center rounded-full border-2 text-center font-mono ${ring}`}
    >
      ...
      <div className="flex flex-col items-center px-3.5 text-[0.66rem] leading-relaxed tracking-[0.12em] uppercase">
        ...
        <strong className={`mb-0.5 block font-display text-base tracking-wider ${strongColor}`}>
          ADV
        </strong>
        {line1}
        <br />
