...
export function Sobre() {
  return (
    <section
      id="nosotros"
      className="bg-white px-6 py-[88px]"
      aria-label="Sobre el administrador"
    >
      <div className="mx-auto grid max-w-[1120px] grid-cols-1 items-center gap-14 md:grid-cols-[0.85fr_1.15fr]">
        ...
        <div className="order-1 md:order-2">
          ...
          <h2 className="mb-5 font-display text-[clamp(1.9rem,3.6vw,2.5rem)] font-extrabold uppercase leading-[1.02] text-forest">
            Un negocio familiar, con trato directo
          </h2>
          <p className="mb-4 text-[1.02rem] text-[#33402e]">
            Administración del Valle (ADV) es un emprendimiento familiar dedicado a la
            administración de consorcios en Buenos Aires. Walter Carrizo está a cargo
